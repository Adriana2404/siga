...
import com.autentico.beans.ProductoFacade;
...
public class ProductoController implements Serializable {
    ...
    @EJB
    private com.autentico.beans.ProductoFacade ejbFacade;
    ...
    public BarChartModel getModel() {
        ...
        List<Producto> chartItems = ejbFacade.findAll();
        ChartSeries productosSerie = new ChartSeries();
        productosSerie.setLabel("Productos");
        
        for(Producto producto: chartItems){
            productosSerie.set(producto.getNombreProducto(), producto.getExistenciasTotales());
        }
        model.addSeries(productosSerie);
        model.setSeriesColors("FCD94B");
        model.setTitle("Productos Por Existencias");
        model.setLegendPosition("ne");
        Axis xAxis = model.getAxis(AxisType.X);
        xAxis.setLabel("Productos");
        Axis yAxis = model.getAxis(AxisType.Y);
        yAxis.setLabel("Existencias");
        yAxis.setMin(0);
